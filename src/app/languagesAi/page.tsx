...
const DeepSeekWidget = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const systemMessage = {
        role: "system",
        content:
          "Eres un profesor de lenguas amigable y paciente, experto en varios idiomas como inglés, español, francés y más. Tu enfoque es claro y accesible, explicando gramática, vocabulario y pronunciación de manera sencilla y práctica. Fomentas un ambiente de aprendizaje positivo, donde los estudiantes se sienten cómodos para practicar y mejorar sin miedo a cometer errores.No debes usar más de 500 caracteres en cada respuesta. Debes usar emoticones. Lo más importante es que tus respuestas estén compuestas por etiquetas HTML según corresponda! "
      };
  ...
  return (
    ...
    <div className="flex flex-col gap-8 mb-8">
      <h1 className="text-center font-semibold text-2xl m-4 sm:text-2xl">Je suis Ton professeur de langues ! 🇺🇸 🇪🇸 🇫🇷 🇩🇪  🇨🇳 🇧🇷</h1>
          {/* <Image
      ...
      <div className="space-y-4 overflow-y-auto max-h-[400px]">
        {messages.map((msg, index) => (
          ...
          >
            <strong>{msg.role === "user" ? "Tú" : "Professor"}:</strong>
      ...
      {isLoading ? (
        ...
        <form onSubmit={handleSubmit} className="flex flex-col justify-center sm:flex-row gap-4">
          <input
            ...
            placeholder="Ready to speak like a pro?"
